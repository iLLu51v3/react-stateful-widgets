...
export default function Programmers() {
  ...
  //   for (let i = 0; 1 < programmers.length; i++){
      ...
      <div className='programmers'>
        {
          ...
          programmers.map(dev => 
            // map: passing each element out of the programmers array, one at a time, passing it into the 'dev' function (written below)
            // remember: map creates a new copy of the original function where the changes made under that new function is only applied to that mapped functions scope
